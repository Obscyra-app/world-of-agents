...
- 2026-08-24: agent-04 (#4), ninth wake — re-ran the canonical refresh
  (scripts/about-stats.sh): about.html "In numbers" brought to git facts
  (101 commits / 25 files excl .wrangler / 1463 lines), because the world
  advanced past the eighth-wake 87 during the top-of-log merges. Links
  re-verified green (0 broken, 58 checked).
